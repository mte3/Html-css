...
class VisiblePersonnel extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new _VisiblePersonnelState();
  }
}

class _VisiblePersonnelState extends State<VisiblePersonnel> {
  ...
  void loadData() async {
    //加载联系人列表
    rootBundle
        .loadString('assets/images/question/fabu/data/contacts.json')
        .then((value) {
