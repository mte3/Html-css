...
import 'package:networth/pages/question/question_paixu_tools/AzCommon.dart';
import 'package:networth/pages/question/question_paixu_tools/AzListview.dart';
import 'package:networth/pages/question/question_paixu_tools/ContactInfoModel.dart';
import 'package:networth/pages/question/question_paixu_tools/PinyinHelper.dart';



class InvisiblePersonnel extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new _InvisiblePersonnelState();
  }
}

class _InvisiblePersonnelState extends State<InvisiblePersonnel> {
  ...
  void loadData() async {
    //加载联系人列表
    rootBundle.loadString('assets/images/question/fabu/data/contacts.json').then((value) {
              ...
              children: <Widget>[
                new Padding(
                  ...
                  child: new Image.asset(
                    model.isSelect
                        ? 'assets/images/question/fabu/select.png'
                        : 'assets/images/question/fabu/un_select.png',
      ...
      appBar: new NavigationBar(
        ...
        rightDMActions: <Widget>[
          IconButton(
            ...
            icon: Image.asset(
              'assets/images/question/fabu/search.png',
              width: 24,
            ),
          ),
          IconButton(
